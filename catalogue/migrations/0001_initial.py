# Generated by Django 3.2.20 on 2023-09-01 07:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('legend', models.FileField(blank=True, null=True, upload_to=catalogue.models.legendFilePath)),
                ('source_legend', models.FileField(blank=True, editable=False, null=True, upload_to=catalogue.models.sourceLegendFilePath)),
            ],
            options={
                'ordering': ['identifier'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.FileField(upload_to=catalogue.models.styleFilePath)),
                ('record', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='styles', to='catalogue.record')),
            ],
        ),
        migrations.AddField(
            model_name='record',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('point_of_contact', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='catalogue.collaborator')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, unique=True, validators=[django.core.validators.RegexValidator(re.compile('^[a-z0-9_]+$'), 'Slug can only contain lowercase letters, numbers and underscores', 'invalid')])),
                ('description', models.TextField(blank=True)),
                ('last_modify_time', models.DateTimeField(auto_now=True)),
                ('create_time', models.DateTimeField(auto_now_add=True)),
                ('records', models.ManyToManyField(to='catalogue.Record')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='catalogue.application')),
                ('layer', models.ForeignKey(limit_choices_to={'active': True}, on_delete=django.db.models.deletion.PROTECT, to='catalogue.record')),
            ],
            options={
