...
from catalogue.models import Application, Record


class RecordAPITestCase(TestCase):
    def setUp(self):
        # Generate a test user for endpoint responses.
        self.testuser = User.objects.create_user(username="testuser", email="testuser@dbca.wa.gov.au.com", password="pass")
